...
func update_bitbox_detection(delta: float) -> void:
	# Temporizador
...
func damage(amount: int) -> void:
	...
	health -= amount
	print("Player recebeu dano de ", amount, ", A vida atual é de ", health, "/", max_health)
...
func heal(amount: int) -> int:
	...
	if health > max_health:
		health = max_health
	print("Player recebeu cura de ", amount, ", a vida atual é de ", health, "/", max_health)
	return health
